		...
		.reply(
			201,
			{
				content: {
					...
					_links: {
						self:
							'https://api.github.com/repos/lucaju/misc/contents/text10.txt?ref=dev',
						git:
							'https://api.github.com/repos/lucaju/misc/git/blobs/e5f345781ca3c2fd6df65bdedba803966cec0435',
	...
	return nock('https://api.github.com:443', {
		...
		.reply(
			201,
			{
				...
				review_comment_url:
					'https://api.github.com/repos/lucaju/misc/pulls/comments{/number}',
				...
				head: {
					...
					repo: {
						...
						owner: {
							...
							followers_url: 'https://api.github.com/users/lucaju/followers',
							following_url:
								'https://api.github.com/users/lucaju/following{/other_user}',
							gists_url: 'https://api.github.com/users/lucaju/gists{/gist_id}',
							starred_url:
								'https://api.github.com/users/lucaju/starred{/owner}{/repo}',
							subscriptions_url: 'https://api.github.com/users/lucaju/subscriptions',
							organizations_url: 'https://api.github.com/users/lucaju/orgs',
							repos_url: 'https://api.github.com/users/lucaju/repos',
							events_url: 'https://api.github.com/users/lucaju/events{/privacy}',
							received_events_url:
								'https://api.github.com/users/lucaju/received_events',
							type: 'User',
							site_admin: false,
						},
						...
						issue_events_url:
							'https://api.github.com/repos/lucaju/misc/issues/events{/number}',
						...
						git_commits_url:
							'https://api.github.com/repos/lucaju/misc/git/commits{/sha}',
						...
						compare_url:
							'https://api.github.com/repos/lucaju/misc/compare/{base}...{head}',
						merges_url: 'https://api.github.com/repos/lucaju/misc/merges',
						archive_url:
							'https://api.github.com/repos/lucaju/misc/{archive_format}{/ref}',
						...
						milestones_url:
							'https://api.github.com/repos/lucaju/misc/milestones{/number}',
						notifications_url:
